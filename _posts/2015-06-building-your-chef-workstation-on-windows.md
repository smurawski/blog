...
cd workstation-repo</pre><h2 id="step3createourwrappercookbook">Step 3 - create our wrapper cookbook
...
popd</pre><h2 id="step4updatecookbookmetadata">Step 4 - Update cookbook metadata
...
cookbook 'winbox', git: 'https://github.com/smurawski/winbox.git', branch: 'smurawski/updates'</pre>
    ...
    <h2 id="step5createourrecipe">Step 5 - Create our recipe
